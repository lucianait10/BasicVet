...
public class MakeReportCliente {
	
	public static String BASE = (new java.io.File("")).getAbsolutePath(); 
	public static String PATH_SOURCE_REPORT = BASE + "/src/cuGestionarCliente/report/xml/";
	public static String PATH_OUTPUT_REPORT = BASE + "/bin/cuGestionarCliente/report/xml/";
	...
	public static void main(String[] args) {
		...
		MakeReportCliente.make(nameReport);
	}
