...
import cuGestionarProveedor.GUIGestionarProveedor;

@SuppressWarnings({ "unchecked"})
public class ReporteProveedor {
	public GUIGestionarProveedor framePrincipal;
	
	public ReporteProveedor(GUIGestionarProveedor guiGestionarProveedor) {
		this.framePrincipal = guiGestionarProveedor;
	}
	...
	public void viewReport(Object[][] param, String[] fieldXml, String nameReport, Object[][]values) {
		try {
			...
			String fileNameReport = MakeReportProveedor.PATH_OUTPUT_REPORT + nameReport + ".jasper";
			JasperPrint jasperprint= JasperFillManager.fillReport(fileNameReport,parameters,data);
			JasperViewer visor=new JasperViewer(jasperprint,false);
            visor.setTitle("Lista Proveedores");
	...
	public void viewFicha(Object[][] proveedor, String nombre, String direccion, String telefono, String cuil) {
		try{
			...
			this.viewReport(parametros, filedXml, nameReport, proveedor);
