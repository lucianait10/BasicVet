...
public class MakeReportCartilla {
	
	public static String BASE = (new java.io.File("")).getAbsolutePath(); 
	public static String PATH_SOURCE_REPORT = BASE + "/src/cuGestionarCartilla/report/xml/";
	public static String PATH_OUTPUT_REPORT = BASE + "/bin/cuGestionarCartilla/report/xml/";
	...
	public static void main(String[] args) {
		...
		MakeReportCartilla.make(nameReport);
	}
