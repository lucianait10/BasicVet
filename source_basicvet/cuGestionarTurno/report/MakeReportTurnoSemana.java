...
public class MakeReportTurnoSemana {
	
	public static String BASE = (new java.io.File("")).getAbsolutePath(); 
	public static String PATH_SOURCE_REPORT = BASE + "/src/cuGestionarTurno/report/xml/";
	public static String PATH_OUTPUT_REPORT = BASE + "/bin/cuGestionarTurno/report/xml/";
	...
	public static void main(String[] args) {
		...
		MakeReportTurnoSemana.make(nameReport);
	}
}
