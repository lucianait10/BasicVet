...
public class MakeReportCompra {
	
	public static String BASE = (new java.io.File("")).getAbsolutePath(); 
	public static String PATH_SOURCE_REPORT = BASE + "/src/cuGestionarCompra/report/xml/";
	public static String PATH_OUTPUT_REPORT = BASE + "/bin/cuGestionarCompra/report/xml/";
	...
	public static void main(String[] args) {
		...
		MakeReportCompra.make(nameReport);
	}
