...
package cuGestionarCompra.report;
...
import cuGestionarCompra.GUIGestionarCompra;


public class ReporteCompra{
	public GUIGestionarCompra framePrincipal;
	    
	public ReporteCompra(GUIGestionarCompra gesCompra) {
		this.framePrincipal=gesCompra;
	}
	...
	public void viewReport(Object[][] param, String[] fieldXml, String nameReport, Object[][]values) {
		try {
			...
			String fileNameReport = MakeReportCompra.PATH_OUTPUT_REPORT + nameReport + ".jasper";
			JasperPrint jasperprint= JasperFillManager.fillReport(fileNameReport,parameters,data);
			JasperViewer visor=new JasperViewer(jasperprint,false);
            visor.setTitle("Lista Compra");
	...
	public void viewFicha(Object[][] compras, String nombre, String direccion, String telefono, String cuil) {
		try{
			Object[][] parametros = {{"direccionVet", direccion},{"telefonoVet", telefono},{"nombreVet",nombre},{"cuil",cuil}};
			String[] filedXml = {"id","fecha","producto","proveedor","cantidad","precio","total"};
			String nameReport = "Compra";
			this.viewReport(parametros, filedXml, nameReport, compras);
