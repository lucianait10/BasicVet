...
public class MakeReportVenta {
	
	public static String BASE = (new java.io.File("")).getAbsolutePath(); 
	public static String PATH_SOURCE_REPORT = BASE + "/src/cuGestionarVenta/report/xml/";
	public static String PATH_OUTPUT_REPORT = BASE + "/bin/cuGestionarVenta/report/xml/";
	...
	public static void main(String[] args) {
		...
		MakeReportVenta.make(nameReport);
	}
