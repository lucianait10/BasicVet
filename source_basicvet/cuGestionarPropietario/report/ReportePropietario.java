...
import cuGestionarPropietario.GUIGestionarPropietario;

@SuppressWarnings({ "unchecked"})
public class ReportePropietario {
	public GUIGestionarPropietario framePrincipal;
	
	public ReportePropietario(GUIGestionarPropietario gesPropietario) {
		this.framePrincipal=gesPropietario;
	}
	...
	public void viewReport(Object[][] param, String[] fieldXml, String nameReport, Object[][]values) {
		try {
			...
			String fileNameReport = MakeReportPropietario.PATH_OUTPUT_REPORT + nameReport + ".jasper";
			JasperPrint jasperprint= JasperFillManager.fillReport(fileNameReport,parameters,data);
			JasperViewer visor=new JasperViewer(jasperprint,false);
            visor.setTitle("Lista Propietarios");
	...
	public void viewFicha(Object[][] propietarios, String nombre, String direccion, String telefono, String cuil) {
		try{
			...
			String[] filedXml = {"dni","nombre", "apellido", "telefono","direccion"};
			String nameReport = "Propietario";
