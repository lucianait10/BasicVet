...
package cuGestionarVeterinario.report;
...
import cuGestionarVeterinario.GUIGestionarVeterinario;

@SuppressWarnings({ "unchecked"})
public class ReporteVeterinario {
	public GUIGestionarVeterinario framePrincipal;
	
	public ReporteVeterinario(GUIGestionarVeterinario gesVeterinario) {
		this.framePrincipal = gesVeterinario;
	}
	...
	public void viewReport(Object[][] param, String[] fieldXml, String nameReport, Object[][]values) {
		try {
			...
			String fileNameReport = MakeReportVeterinario.PATH_OUTPUT_REPORT + nameReport + ".jasper";
			JasperPrint jasperprint= JasperFillManager.fillReport(fileNameReport,parameters,data);
			JasperViewer visor=new JasperViewer(jasperprint,false);
            visor.setTitle("Lista Veterinarios");
	...
	public void viewFicha(Object[][] propietarios, String nombre, String direccion, String telefono, String cuil) {
		try{
			...
			String[] filedXml = {"dni","nombre","apellido", "telefono","matricula"};
			String nameReport = "Veterinario";
