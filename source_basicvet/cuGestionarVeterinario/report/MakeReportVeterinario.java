...
public class MakeReportVeterinario {
	
	public static String BASE = (new java.io.File("")).getAbsolutePath(); 
	public static String PATH_SOURCE_REPORT = BASE + "/src/cuGestionarVeterinario/report/xml/";
	public static String PATH_OUTPUT_REPORT = BASE + "/bin/cuGestionarVeterinario/report/xml/";
	...
	public static void main(String[] args) {
		...
		MakeReportVeterinario.make(nameReport);
	}
}
