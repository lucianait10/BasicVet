...
public class MakeReportProducto {
	
	public static String BASE = (new java.io.File("")).getAbsolutePath(); 
	public static String PATH_SOURCE_REPORT = BASE + "/src/cuGestionarProducto/report/xml/";
	public static String PATH_OUTPUT_REPORT = BASE + "/bin/cuGestionarProducto/report/xml/";
	...
	public static void main(String[] args) {
		...
		MakeReportProducto.make(nameReport);
	}	
}
