...
public class MakeReportAnimal {
	  
	public static String BASE = (new java.io.File("")).getAbsolutePath(); 
	public static String PATH_SOURCE_REPORT = BASE + "/src/cuGestionarAnimal/report/xml/";
	public static String PATH_OUTPUT_REPORT = BASE + "/bin/cuGestionarAnimal/report/xml/";
	...
	public static void main(String[] args) {
		...
		MakeReportAnimal.make(nameReport);
	}
}
