...
public class MakeReportFichaClinica {
	  
	public static String BASE = (new java.io.File("")).getAbsolutePath(); 
	public static String PATH_SOURCE_REPORT = BASE + "/src/cuGestionarFichaClinica/report/xml/";
	public static String PATH_OUTPUT_REPORT = BASE + "/bin/cuGestionarFichaClinica/report/xml/";
	...
	public static void main(String[] args) {
		...
		MakeReportFichaClinica.make(nameReport);
	}
